function MakePictures(result,geo,env,gamma,InputRelPath)
...
%giffilename = char({strcat('InputRelPath',geo.UserFileName,datestr(now,30),'.gif')});
...
giffilename = char({strcat('InputRelPath',geo.UserFileName,'0',datestr(now,30),'.gif')});
